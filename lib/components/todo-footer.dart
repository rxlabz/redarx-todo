...
class TodoFooter extends ComponentBase {
  ...
  set showCompleted(bool value){
      ...
      btToggle.text = value ? "Remaining ( $_numRemaining )" : "Completed ( $_numCompleted )";
      label.text = value ? "Completed : ${_numCompleted}" : "Remaining : ${_numRemaining}";
  }
  ...
  createChildren() {
    ...
    btClear = new AnchorElement(href: '#')
      ..text = "Clear"
      ..onClick
          .listen((e) => dispatch(new Request(RequestType.CLEAR_ARCHIVES)));

    btToggle = new AnchorElement(href: '#')
      ..text = "Show completed"
      ..onClick.listen(
          (e) => dispatch(new Request(RequestType.TOGGLE_SHOW_COMPLETED)));
